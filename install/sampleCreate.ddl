create table address (address_id integer generated by default as identity (start with 1), city varchar(15) not null, country varchar(20) not null, house_flat_no integer not null, postcode varchar(8) not null, street varchar(255) not null, primary key (address_id))
